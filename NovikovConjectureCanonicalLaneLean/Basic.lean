/-!
# novikov-conjecture-canonical-lane Lean migration boundary
...
`NovikovConjectureCanonicalLaneLean/SourcePackage.lean`.
...
def sourceRepository : String := "novikov-conjecture-canonical-lane"
def sourceUrl : String := "https://github.com/HautevilleHouse/novikov-conjecture-canonical-lane"
def sourceDescription : String := "Canonical-lane closure package for the Novikov conjecture: admissible-class formulation, projection gates, local-to-global bridge, and carried remainder."
def sourceClassification : String := "abstract_math_theorem_repo"
def sourceTopics : List String := ["novikov-conjecture", "higher-signatures", "geometric-topology", "k-theory", "geometric-group-theory", "mathematical-proof", "reproducibility", "canonical-lane", "local-to-global", "manifold-constrained"]
